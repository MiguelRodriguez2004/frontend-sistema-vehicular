  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between pb-1">
        <span className="text-[11px] font-black tracking-wider text-slate-800 dark:text-slate-200 uppercase flex items-center gap-1.5">
          <span className="w-1.5 h-1.5 rounded-full bg-blue-500 shrink-0"></span>
          {ordenId}
        </span>
        <OrdenStatusBadge value={estado} type="status" className="px-2 py-0.5 text-[9px]" />
      </div>
      ...
      <div className="flex items-start justify-between gap-3 border-b border-slate-100 dark:border-slate-700/40 pb-2.5">
        <div className="space-y-0.5 min-w-0 flex-1">
          ...
          <h4 className="text-[14px] font-extrabold text-slate-900 dark:text-white flex items-center gap-1.5 truncate" title={vehiculoInfo}>
            <Car className="w-3.5 h-3.5 text-slate-400 shrink-0" />
            <span className="truncate">{vehiculoInfo}</span>
          </h4>
          {/* Cliente - Secundario */}
          <div className="flex items-center gap-1 text-[11px] text-slate-500 dark:text-slate-400 pl-5 truncate" title={clienteNombre}>
        ...
        <span className="shrink-0 px-2.5 py-1 rounded-md bg-blue-50/40 dark:bg-blue-900/10 text-blue-600 dark:text-blue-400 font-extrabold tracking-widest text-[11px] border border-blue-100/50 dark:border-blue-900/20 uppercase shadow-3xs">
          {placa}
        </span>
      </div>

      {/* 3. Metadata Matriz: Servicio, Kilometraje, Técnico, Fecha, Novedades */}
      <div className="grid grid-cols-2 gap-x-4 gap-y-2 border-b border-slate-100 dark:border-slate-700/40 pb-2.5 text-[10px]">
        {/* Fila 1 */}
        <div className="space-y-0.5">
          <span className="text-slate-400 dark:text-slate-500 font-bold block uppercase tracking-wide">Servicio</span>
          <OrdenStatusBadge value={tipoServicio} type="service" className="px-1.5 py-0 text-[8.5px] mt-0.5" />
        </div>
        <div className="space-y-0.5">
          <span className="text-slate-400 dark:text-slate-500 font-bold block uppercase tracking-wide">Kilometraje</span>
        ...
        {/* Fila 2 */}
        <div className="space-y-0.5">
          <span className="text-slate-400 dark:text-slate-500 font-bold block uppercase tracking-wide">Técnico</span>
          <span className="font-semibold text-slate-700 dark:text-slate-350 truncate block mt-0.5" title={tecnicoNombre}>
            {tecnicoNombre}
          </span>
        </div>
        <div className="space-y-0.5">
          <span className="text-slate-400 dark:text-slate-500 font-bold block uppercase tracking-wide">Fecha</span>
          <div className="flex items-center gap-1 text-slate-650 dark:text-slate-350 font-semibold block mt-0.5">
      ...
      {diagnostico && (
        <div className="text-[11px] text-slate-500 dark:text-slate-400 italic leading-relaxed line-clamp-2 break-words">
          "{diagnostico}"
        </div>
      )}
      ...
      <div className="flex items-center justify-between pt-2 border-t border-slate-100 dark:border-slate-700/40">
        ...
        <div className="flex items-center gap-1 text-[10px] text-slate-400">
          ...
          <span>Novedades:</span>
          <span className={`inline-flex items-center justify-center px-1.5 py-0.5 font-bold rounded text-[9px] ${
            cantidadNovedades > 0
        ...
        <Button
          ...
          variant="secondary"
          size="sm"
          className="h-7 px-2.5 py-0 text-[10.5px] font-bold shrink-0 hover:bg-slate-200 dark:hover:bg-slate-700 group-hover:bg-blue-600 group-hover:text-white transition-colors duration-200 shadow-3xs"
        >
          Ver Detalle
        </Button>
      </div>
